...
# endpoint for checking URLs against VirusTotal API
...
def check_url_virustotal():
    ...
    is_phishing = False
    if 'data' in api_response and 'attributes' in api_response['data']:
        stats = api_response['data']['attributes']['last_analysis_stats']
...
def convert_to_chartjs_format(data):
    ...
    return url_type_data, ip_data, time_data, url_data, hour_data, tld_data, length_data
